...
public class ChatBot extends AppCompatActivity {
    ...
    private void getResponse (String message){
        ...
        String url ="http://api.brainshop.ai/get?bid=167457&key=DQOeJG1NmufDfRIy&uid=[uid]&msg="+message;
        String BASE_URL = "http://api.brainshop.ai/";
//        String url ="http://20.197.50.34:5006/webhooks/rest/webhook="+message;
//        String BASE_URL = "http://api.brainshop.ai/";
